...
const MainText = ({ handleAnimation, handleAnimationMoveBack }) => {
    ...
    return (
        <>
            ...
            <p className='main_text'> I am currently studing on <span onMouseOver={handleAnimation} onMouseOut={handleAnimationMoveBack}>Node.js</span>, hopefully will not take more than a month to be able to implement it professionally.</p>
        </>
    )
}
