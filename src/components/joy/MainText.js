...
const MainText = ({ handleAnimation, handleAnimationMoveBack }) => {
    ...
    return (
        <>
            ...
            <p className='main_text'> Am currently studying on <a href='https://www.w3schools.com/nodejs/default.asp' onMouseOver={handleAnimation} onMouseOut={handleAnimationMoveBack}>Node.js</a >, hopefully won't take much to implement it into my projects professionally and confidently.</p>
            <p className='main_text'> Then, in a couple of shakes, wanna be confident with <a href='https://www.w3schools.com/mysql/default.asp' onMouseOver={handleAnimation} onMouseOut={handleAnimationMoveBack}>MySQL</a > and <a href='https://www.mongodb.com/' onMouseOver={handleAnimation} onMouseOut={handleAnimationMoveBack}>MongoDB.</a ></p>
        </>
    )
}
